...
public class BasicResourceFunctionalTesting {
    ...
    private static final String URL_API = "http://localhost:8080/SpringAPIREST.0.0.1-SNAPSHOT" + Uris.SERVLET_MAP;
    ...
    public void testCalculadora2() {
        URI uri = UriComponentsBuilder.fromHttpUrl(URL_API + Uris.ADMINS + Uris.CALC2).build().encode().toUri();
        RequestEntity<Object> requestEntity = new RequestEntity<>(HttpMethod.GET, uri);
